...
func NewServer(user, address, key string, pass []byte) (*Server, error) {
	var host string
	var hostname string
	var port string
...
func reconcile(precedent, subsequent string) string {
	if precedent != "" {
		return precedent
	}
	return subsequent
